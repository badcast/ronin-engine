...
namespace RoninEngine
{
    namespace Runtime
    {
        ...
        public:
            ...
            static Sprite* create_sprite2D_box(Vec2Int size = { 5, 5 }, Color fillColor = Color::white);
            static Sprite* create_sprite2D_circle(Vec2Int size = { 5, 5 }, float radius = 1.f, Color fillColor = Color::white);
        };
    } // namespace Runtime
} // namespace RoninEngine
