...
template <>
struct type2index<SDL_Texture>
    : public type2index_low<SDL_Texture, 1> {  // SDL Texture
};
template <>
struct type2index<SDL_Surface>
    : public type2index_low<SDL_Surface, 2> {  // SDL Surface
};
template <>
struct type2index<Texture>
    : public type2index_low<Texture, 32> {  // Ronin Texture
};
template <>
...
template <typename T>
struct type2index
    : public type2index_low<std::enable_if_t<std::is_base_of_v<Object, T>, T>,
                            128> {  // Ronin Object
};
...
template <typename T>
struct is_sdl_type
    : public std::integral_constant<bool, type2index<T>::typeIndex <=
                                              SDL_TYPE_MAX_INDEX> {};
template <typename T>
struct is_invalid_type
    : public std::integral_constant<bool,
                                    type2index<T>::typeIndex == InvalidType> {};
