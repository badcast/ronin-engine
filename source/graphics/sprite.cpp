...
namespace RoninEngine::Runtime
{
    ...
    Sprite* Sprite::spriteEmpty() { return Primitive::create_sprite2D(Vec2Int::one, Color::black); }
    Sprite* Sprite::spriteBlack() { return Primitive::create_sprite2D(Vec2Int::one * 100, Color::black); }
    Sprite* Sprite::spriteWhite() { return Primitive::create_sprite2D(Vec2Int::one, Color::white); }
